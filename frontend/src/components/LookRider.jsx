...
function LookRider(props) {
  return (
     <div className='h=[50%]'>
         <h3 className='text-2xl font-bold my-1'>Searching For Rider</h3>
        <div className='flex gap-3 justify-between items-center flex-col'>
            ...
            <div className='w-full flex flex-col gap-0'>
                ...
                }} className='flex justify-center'><i class="ri-bank-card-fill"></i> <h1 className='font-bold mr-2'>Pay:</h1> <h1>200</h1></div>
            </div>
