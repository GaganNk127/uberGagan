  ...
  return (
    <div className='p-7 flex flex-col  justify-between'>
        ...
        <form onSubmit={(e)=>{
            ...
            <Link to={'/signup'} className='text-blue-600'><span className= 'text-black ml-8'>New here? </span>Create new Account</Link>
        </form>
           </div>
           <div>
           <Link to={'/captain-login'} className='flex items-center justify-center bg-yellow-500 w-full text-black py-3 rounded mt-60 font-semibold' >Sign in As Captain</Link>
           </div>
    </div>
  )
}
