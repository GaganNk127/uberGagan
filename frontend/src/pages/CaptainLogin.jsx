    ...
    return (
      <div className='p-7 flex flex-col  justify-between'>
          ...
          <form onSubmit={(e)=>{
              ...
              <h3 className='text-xl font-medium mb-2'> Whats's Your Email</h3>
              ...
              <button className='flex items-center justify-center bg-black w-full text-white py-3 rounded mt-4'>Login</button>
              <Link to={'/captain-signup'} className='text-blue-600'><span className= 'text-black ml-3'>Register as captain? </span>Create new Account</Link>
          </form>
             </div>
             <div>
             <Link to={'/login'} className='flex items-center justify-center bg-green-500 w-full text-black py-3 rounded mt-60 font-semibold' >Sign in As User</Link>
             </div>
      </div>
    )
}
